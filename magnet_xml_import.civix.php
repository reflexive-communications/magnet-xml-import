...
function _magnet_xml_import_civix_civicrm_install()
{
    ...
    if ($upgrader = _magnet_xml_import_civix_upgrader()) {
        $upgrader->onInstall();
    }
}
 ...
 */
function _magnet_xml_import_civix_civicrm_postInstall()
{
    _magnet_xml_import_civix_civicrm_config();
    if ($upgrader = _magnet_xml_import_civix_upgrader()) {
 ...
 */
function _magnet_xml_import_civix_civicrm_uninstall()
{
    _magnet_xml_import_civix_civicrm_config();
    if ($upgrader = _magnet_xml_import_civix_upgrader()) {
 ...
 */
function _magnet_xml_import_civix_civicrm_enable()
{
    _magnet_xml_import_civix_civicrm_config();
    if ($upgrader = _magnet_xml_import_civix_upgrader()) {
 ...
 * @return mixed
 */
function _magnet_xml_import_civix_civicrm_disable()
{
    _magnet_xml_import_civix_civicrm_config();
    if ($upgrader = _magnet_xml_import_civix_upgrader()) {
...
/**
 * @return CRM_MagnetXmlImport_Upgrader
 */
 ...
 * @return array
 */
function _magnet_xml_import_civix_find_files($dir, $pattern)
{
    ...
    while (!empty($todos)) {
        ...
        foreach (_magnet_xml_import_civix_glob("$subdir/$pattern") as $match) {
            if (!is_dir($match)) {
                $result[] = $match;
            }
        }
 ...
 */
function _magnet_xml_import_civix_civicrm_managed(&$entities)
{
    $mgdFiles = _magnet_xml_import_civix_find_files(__DIR__, '*.mgd.php');
    sort($mgdFiles);
 ...
 * @return bool
 */
function _magnet_xml_import_civix_insert_navigation_menu(&$menu, $path, $item)
{
 ...
 */
function _magnet_xml_import_civix_navigationMenu(&$nodes)
{
    if (!is_callable(['CRM_Core_BAO_Navigation', 'fixNavigationMenu'])) {
        _magnet_xml_import_civix_fixNavigationMenu($nodes);
    }
}
 ...
 * missing them.
 */
function _magnet_xml_import_civix_fixNavigationMenu(&$nodes)
{
    $maxNavID = 1;
    ...
    _magnet_xml_import_civix_fixNavigationMenuItems($nodes, $maxNavID, null);
}

function _magnet_xml_import_civix_fixNavigationMenuItems(&$nodes, &$maxNavID, $parentID)
{
    ...
    foreach ($origKeys as $origKey) {
        ...
        if (isset($nodes[$origKey]['child']) && is_array($nodes[$origKey]['child'])) {
            _magnet_xml_import_civix_fixNavigationMenuItems($nodes[$origKey]['child'], $maxNavID, $nodes[$origKey]['attributes']['navID']);
        }
    }
}
 ...
 */
function _magnet_xml_import_civix_civicrm_entityTypes(&$entityTypes)
{
